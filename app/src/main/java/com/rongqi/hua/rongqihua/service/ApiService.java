...
public interface ApiService {
    @POST("admin/insert")
    Call<BooleanResp> adminInsert(@Body AccountReq accountReq);
...
//    Call<BaseResp> userlogUpdateByPrimaryKey(@Body UserLoginReq userLoginReq);
    ...
    @POST("rela/insert")
    Call<BooleanResp> relaInsert(@Query("nid") String nid, @Query("uuid") String uuid);
...
//    typeId:人员类型，uuId:合伙人微信编号，name：学生（或者工人、汽车销售等）名字，nid:身份证号码，phone:电话号码，sId: 学生（或者工人、汽车销售等）编号，sex:性别，major:专业，graduate：毕业学校
    @POST("student/insert")
    Call<BooleanResp> studentInsert(@Query("typeId") Integer typeId, @Query("uuId") String uuId, @Body Child child);
